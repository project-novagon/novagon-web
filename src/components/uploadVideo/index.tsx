  ...
  return (
    <div>
      ...
      <form  className="p-1" onSubmit={submitHandler}>
        ...
        {vid && <button className="px-4 py-2 text-sm font-bold rounded-full  bg-gray-secondary text-mauve bg-zinc-100 hover:bg-zinc-200  hover:bg-zinc-700" type="submit">Upload Image</button>}
      </form>
    </div>
  );
};

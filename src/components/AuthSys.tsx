...
export function SignIn() {
  ...
  return (
    <>
      ...
      <div className="md:h-[86vh] h-[90vh] w-full flex justify-center md:items-center  items-end flex-col bg-gradient-to-bl from-violet-500 to-violet-900 rounded-lg ">
        <div className="inline-flex flex-col items-center justify-center w-full h-screen gap-8 px-12 py-8 rounded-none shadow-lg md:w-96 md:h-80 bg-zinc-600 md:rounded-lg">
          ...
          <div className="p-[0px] flex-col justify-center items-center gap-4 flex">
            <button className="sign-in-btn button-secondary" onClick={signInAsGuest}>
              <UserIcon className="relative w-6 h-6" />
              Sign in as Guest
            </button>
                  ...
                  <g id="Google Icon" clip-Path="url(#clip0_143_114)">
                    <g id="Group">
                      ...
                      <path id="Vector_2"
                        ...
                        fill="#34A853" />
                      <path id="Vector_3"
                        d="M6.02488 14.29C5.77488 13.57 5.64488 12.8 5.64488 12C5.64488 11.2 5.78488 10.43 6.02488 9.71V6.62H2.04488C1.22488 8.24 0.754883 10.06 0.754883 12C0.754883 13.94 1.22488 15.76 2.04488 17.38L6.02488 14.29Z"
                        fill="#FBBC05" />
                      <path id="Vector_4"
  ...
  if (user) {
    ...
    return (
      <div className="flex items-center justify-center space-x-4 rounded-full dark:bg-zinc-800 bg-zinc-300">
        ...
        <button onClick={() => auth.signOut()} className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-bold rounded-full dark:bg-gray-secondary text-violet-500 bg-zinc-100 hover:bg-zinc-200 dark:hover:bg-zinc-700"> <ArrowRightOnRectangleIcon className='w-6'/> <p className='hidden sm:block'>Sign Out</p></button>
      </div>
    );
  } else {
    return null;
    ...
    <div className="fixed top-0 left-0 z-50 flex items-end justify-center w-full h-full p-4 bg-black bg-opacity-50 sm:items-center sm:p-0 backdrop-blur-lg">
      <div className="space-y-2">
        <div className="flex items-center justify-between p-2 space-x-16 rounded-full dark:bg-zinc-800 bg-zinc-300">
          ...
          <button onClick={onClose} className="w-16 h-8 text-sm font-bold transition-all rounded-full dark:bg-gray-secondary text-violet-500 bg-zinc-100 hover:bg-zinc-200 dark:hover:bg-zinc-500">
            Close
          </button>
        </div>

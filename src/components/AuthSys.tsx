...
export function SignIn() {
  ...
  return (
    ...
    <div className="h-[86vh] w-full flex justify-center items-center flex-col">
      <h2 className="text-2xl font-bold">Welcome To <span className="text-transparent transition-all bg-clip-text bg-gradient-to-r from-primaryBlue-primary to-violet-900 ">The Novagon App</span></h2>

  ...
  return (
    <>
      ...
      <div className="md:h-[86vh] h-[90vh] w-full flex justify-center md:items-center  items-end flex-col bg-gradient-to-bl from-primaryBlue-primary to-logoPink">
        <div className="inline-flex flex-col items-center justify-center w-full h-screen gap-8 px-12 py-8 border-8 rounded-none shadow-lg md:w-96 md:h-80 dark:bg-base bg-subtext1 dark:border-surface0 border-overlay2 md:rounded-2xl">

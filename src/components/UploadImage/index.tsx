      ...
      <form className="p-1" onSubmit={submitHandler}>
        {img && (
          <div className="flex flex-col items-center justify-center w-64 p-4 m-3 space-y-4 rounded-lg dark:bg-zinc-600 bg-zinc-300">
            ...
            <button className="px-4 py-2 text-sm font-bold rounded-full dark:bg-gray-secondary text-violet-500 bg-zinc-100 hover:bg-zinc-200 dark:hover:bg-zinc-700" type="submit">
              Upload Image
            </button>
          </div>
        )}
